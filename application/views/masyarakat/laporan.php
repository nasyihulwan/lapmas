                                    ...
                                    <table class="table" id="table1">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="modal fade"
                                                id="exampleModalScrollable<?= $l->tanggapan_balik ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-centered scrollable"
                                                    ...
                                                    if ($ekstensi_1 == 'mp4') { ?>
                                                                Lampiran 1 - <b><?= $l->lampiran_1 ?></b> - <a
                                                                    href="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_1 ?>"
                                                                    type="button" class="btn badge btn-primary mb-2"
                                                                    download>Download</a>
                                                                <br>
                                                                <video width="730" height="570" controls>
                                                                    <source
                                                                        src="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik?>/<?= $l->lampiran_1 ?>"
                                                                        type="video/mp4">
                                                                ...
                                                                Lampiran 1 - <b><?= $l->lampiran_1 ?></b> - <a
                                                                    ...
                                                                    download>Download</a>
                                                                <br>
                                                                <img src="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_1 ?>"
                                                    ...
                                                    if ($ekstensi_2 == 'mp4') { ?>
                                                                Lampiran 2 - <b><?= $l->lampiran_2 ?></b> - <a
                                                                    href="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_2 ?>"
                                                                    type="button" class="btn badge btn-primary mb-2"
                                                                    download>Download</a>
                                                                <br>
                                                                <video width="730" height="570" controls>
                                                                    <source
                                                                        src="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_2 ?>"
                                                                        type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                ...
                                                                Lampiran 2 - <b><?= $l->lampiran_2 ?></b> - <a
                                                                    ...
                                                                    download>Download</a>
                                                                <br>
                                                                <img src="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_2 ?>"
                                                    ...
                                                    $ekstensi_3 = substr($l->lampiran_3, -3); 
                                                                ...
                                                                Lampiran 3 - <b><?= $l->lampiran_3 ?></b> - <a
                                                                    href="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_3 ?>"
                                                                    type="button" class="btn badge btn-primary mb-2"
                                                                    download>Download</a>
                                                                <br>
                                                                <video width="730" height="570" controls>
                                                                    <source
                                                                        src="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_3 ?>"
                                                                        type="video/mp4">
                                                                    Your browser does not support the video tag.
                                                                </video>
                                                                ...
                                                                Lampiran 3 - <b><?= $l->lampiran_3 ?></b> - <a
                                                                    ...
                                                                    download>Download</a>
                                                                <br>
                                                                <img src="<?= base_url() ?>assets/images/laporan/pengaduan/<?= $l->nik ?>/<?= $l->lampiran_3 ?>"

            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item  has-sub <?php if ($this->uri->segment(1) == 'pengaduan') echo 'active' ?>">
                        ...
                        <li class="sidebar-item <?php if ($this->uri->segment(1) == 'laporan') echo 'active' ?>">
                            <a href="<?= site_url() ?>laporan/pengaduan" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Pengaduan</span>
                            </a>
                        </li>
                        ...
                        <!-- <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="component-alert.html">Edit</a>
                                </li>
                                <li class="submenu-item ">

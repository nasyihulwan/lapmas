    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Belum punya akun? <a href="<?= site_url() ?>auth/register" class="font-bold">Sign
                                up</a>.</p>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <!-- <div class="auth-logo">
                        <a href="index.html"><img src="<?= base_url() ?>assets/landing/images/toobig_logo.png" alt="Logo"></a>
                    </div> -->
                </div>
            </div>
        </div>
